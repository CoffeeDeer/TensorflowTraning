...
tf.app.flags.DEFINE_string("output_graph","./flowers_graph.pb","학습된 신경망이 저장된 위치")
tf.app.flags.DEFINE_string("output_labels","./flowers_labels.txt","학습할 레이블 데이터 파일")
...
def main(_):
    ...
    with tf.Session() as sess:
        ...
        prediction = sess.run(logitx, {'DecodeJpeg/contests:0': image})
